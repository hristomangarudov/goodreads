...
function ListGroupMyBooks(props) {
  ...
  return (
    ...
    <ListGroup variant="flush">
        ...
        <Link className={`link-decoration underline ${current}`} to='/mybooks/currently-reading' ><span>Currenty reading</span></Link>
        <Link className={`link-decoration underline ${want}`} to='/mybooks/want-to-read' ><span>Want to read</span></Link>
        <Link className={`link-decoration underline ${read}`} to='/mybooks/read-books' ><span>Read</span></Link>
        </div>
